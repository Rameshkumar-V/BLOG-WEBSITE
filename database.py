...
class Documents(db.Model):
    ...
    dname = db.Column(db.String(200), unique=True) #document name
    ...
    def __init__(self, dname, ddata, dtype,dimage):
        self.dname = dname
...
def add_document(dname,ddata, dimage, dtype):
    try:
        document_class=Documents(dname=dname,ddata=ddata,dimage=dimage,dtype=dtype)
        ...
        if documents:
            ...
            for document in documents:
                ...
                document_details.append({
                    ...
                    'document_image': document.dimage,
                })
